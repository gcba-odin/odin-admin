...
app.config(['$translateProvider', function($translateProvider, $rootScope) {
    $translateProvider.translations('en', {
        ...
        'Enable/disable mobile disqus': 'Enable/disable mobile disqus',
        'Choose a particular language (Browser language by default)': 'Choose a particular language (Browser language by default)',
        'Choose a particular language': 'Choose a particular language',
        'Disqus Public Key provided through its administration panel': 'Disqus Public Key provided through its administration panel',
        'Disqus Public Key, depends on disqusRemoteAuthS3 field': 'Disqus Public Key, depends on disqusRemoteAuthS3 field',
        'Authentication format provided by Disqus through its administration panel': ' Authentication format provided by Disqus through its administration panel',
        'Authentication format provided by Disqus, depends on disquisApiKey field': 'Authentication format provided by Disqus, depends on disquisApiKey field',
        'Google Private API KEY': 'Google Private API KEY',
        'Google Public API KEY': 'Google Public API KEY',
        'Enable frontend captcha': 'Enable frontend captcha',
        'Enable admin captcha': 'Enable admin captcha',
    ...
    $translateProvider.translations('es', {
        ...
        'Enable/disable mobile disqus': 'Check que permite habilitar/deshabilitar el disqus mobile',
        ...
        'Choose a particular language': 'Permite elegir un lenguaje en particular',
        'Disqus Public Key provided through its administration panel': 'Clave pública provista por Disqus desde el panel de administración del mismo.',
        'Disqus Public Key, depends on disqusRemoteAuthS3 field': 'Clave pública provista por Disqus. Campo dependiente de RemoteAuthS3',
        'Authentication format provided by Disqus through its administration panel': 'Formato de autenticación provisto por Disqus desde el panel de administración del mismo',
        'Authentication format provided by Disqus, depends on disquisApiKey field': 'Formato de autenticación provisto por Disqus. Campo dependiente de disquisApiKey',
        'Google Private API KEY': 'Clave privada de la API de Google',
        'Google Public API KEY': 'Clave pública de la API de Google',
        'Enable frontend captcha': 'Habilitar captcha en el frontend',
        'Enable admin captcha': 'Hablitar captcha en el administador',
        ...
        'Points limit on map creation': 'Limite de puntos para la creación de mapas',
